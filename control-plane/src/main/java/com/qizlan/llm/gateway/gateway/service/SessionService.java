...
public class SessionService {
    ...
    public void bind(HttpServletRequest request, SessionEntity session) {
        request.setAttribute(SESSION_ATTRIBUTE, session);
        request.setAttribute(USER_ATTRIBUTE, session.getUser());
    }

    public Optional<UserEntity> currentUser(HttpServletRequest request) {
        return Optional.ofNullable((UserEntity) request.getAttribute(USER_ATTRIBUTE));
    }
