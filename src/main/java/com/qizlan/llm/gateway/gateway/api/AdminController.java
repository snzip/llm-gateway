...
public class AdminController {
    ...
    public Map<String, Object> organization(@PathVariable String orgId) {
        return Map.of("data", adminMetricsService.organizationDetail(orgId));
    }

    @GetMapping("/organizations/{orgId}/projects")
    public Map<String, Object> organizationProjects(@PathVariable String orgId) {
    ...
    public Map<String, Object> projectMetrics(@PathVariable String orgId, @PathVariable String projectId) {
    ...
    public Map<String, Object> projectLogs(@PathVariable String orgId, @PathVariable String projectId) {
